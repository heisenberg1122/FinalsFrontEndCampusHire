...
// --- SHARED DESIGN PALETTE (Matches AdminDashboard) ---
const palette = {
    surface: "#FFFFFF",
    background: "#F8FAFC",
    textPrimary: "#1E293B",
            ...
            { 
                ...
                onPress: async () => {
                    try {
                        ...
                        // Optional: Add a toast or small alert here
                    } catch (error) {
                        console.log(error);
                        ...
                        <View style={[styles.topNav, { paddingHorizontal: isDesktop ? 32 : 24 }]}>
                            ...
                            <TouchableOpacity onPress={() => navigation.goBack()} style={styles.navLeft}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.screenTitle}>Job Postings</Text>
                                </View>
                            </TouchableOpacity>
            ...
            <View style={styles.surface}>
                {loading ? (
                    ...
                    <FlatList
                        ...
                        // Support Grid layout on desktop
                        ...
                        ListEmptyComponent={
                            <View style={styles.emptyState}>
                                <View style={styles.emptyIconCircle}>
                                    <Ionicons name="briefcase-outline" size={40} color={palette.iconNeutral} />
                                </View>
                                <Text style={styles.emptyTitle}>No Jobs Found</Text>
                                <Text style={styles.emptySub}>Post a new job to get started.</Text>
                            </View>
                        }
...
const styles = StyleSheet.create({
    ...
    jobTitle: { fontSize: 16, fontWeight: '800', color: palette.textPrimary, marginBottom: 4 },
    jobPosition: { fontSize: 13, color: palette.textSecondary, fontWeight: '600' },

    statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    statusText: { fontSize: 11, fontWeight: '800', letterSpacing: 0.5 },

    description: { color: palette.textSecondary, fontSize: 13, lineHeight: 20, marginBottom: 16 },

    // Info Row
    infoRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 15 },
    infoItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: palette.background, paddingVertical: 4, paddingHorizontal: 8, borderRadius: 6 },
    infoText: { color: palette.textPrimary, fontWeight: '600', fontSize: 12, marginLeft: 6 },
